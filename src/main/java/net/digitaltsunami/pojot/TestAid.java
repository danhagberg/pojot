...
/**
 * Tool to provide basic validation of POJO classes in areas related to
 * getters/setters, toString, equals, and hashCode methods.
 * These tests are designed for classes with no special logic associated with
 * setters/getters.
 */
public class TestAid<T> {
    ...
    /**
     * Include a set of fields for testing.  Only the provided fields will be included in getter/setter testing.
     * Only fields with no specialized logic should be included, as this logic might cause
     * the basic validation to fail.
     * <p/>
